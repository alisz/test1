<?php
	...
	$ultimos = array(
		...
		array('idProducto' => '12','Nombre' => 'Apple iPad ','Precio' => '599.99','Stock' => '300','Imagen' => 'https://image.ibb.co/hMHm2o/P002.jpg'),
		array('idProducto' => '13','Nombre' => 'Google Nexus 8','Precio' => '299.99','Stock' => '300','Imagen' => 'https://image.ibb.co/jQVTF8/P003.jpg'),
		array('idProducto' => '14','Nombre' => 'Samsung Galaxy S9','Precio' => '459.99','Stock' => '650','Imagen' => 'https://image.ibb.co/dOjoF8/P004.jpg'),
	...
	header ("Content-Type: application/json"); //php devuelve por default html
	...
	if (isset($_GET["d"])) {
		...
		switch ($data)  {
			...
			break;
			default:
			     echo json_encode(["error"=>"Productos n encontrados"]);
			break;
		}
